...
function updateColors(shouldSave = true) {
    ...
    document.querySelectorAll('h1').forEach(h => {
        if (h !== timeDisplay) h.style.textShadow = `0 0 5px ${neon},0 0 10px ${neon},0 0 20px ${neon},0 0 40px ${neon}`;
    });
...
function getGameDetails(game) {
    ...
    let title = '';
    if (game === 'subway') {
        url = "https://ubg77.github.io/updatefaqs/subway-surfers-nyc/";
        title = 'Subway Surfers';
    }
    if (game === 'geometrydash') {
        url = "https://geometry-dash-lite.io/gdl/";
        title = 'Geometry Dash';
    }
    if (game === 'speedstars') {
        url = "https://speedstars2.io/game/speed-stars/";
        title = 'Speed Stars';
    }
    if (game === 'slope') {
    ...
    if (game === 'motox3m') {
        url = "https://gamecollections.me/game/3kh0-assets-main/motox3m/";
        title = 'Moto X3M';
    }
    if (game === 'ovo') {
        url = "https://gamecollections.me/game/3kh0-assets-main/ovo/";
        title = 'OvO';
    }
    if (game === 'driftboss') {
        url = "https://gamecollections.me/game/3kh0-assets-main/drift-boss/";
        title = 'Drift Boss';
    }
    if (game === 'drivemad') {
    ...
    if (game === 'retrobowl') {
        url = "https://gamecollections.me/game/3kh0-assets-main/retro-bowl/";
        title = 'Retro Bowl';
    }
    if (game === 'basketbros') {
        url = "https://gamecollections.me/game/3kh0-assets-main/basketbros-io/";
        title = 'Basket Bros';
    }
    if (game === 'papasbr') {
        url = "https://gamecollections.me/game/3kh0-assets-main/papaspizzaria/";
        title = 'Papas Burgeria';
    }
    if (game === 'crossyroad') {
        url = "https://gamecollections.me/game/3kh0-assets-main/crossyroad/";
        title = 'Crossy Road';
    }
    if (game === 'smashcarts') {
        url = "https://gamecollections.me/game/3kh0-assets-main/smashkarts/";
        title = 'Smash Karts';
    }
    if (game === 'dogeminer') {
        url = "https://gamecollections.me/game/3kh0-assets-main/DogeMiner/";
        title = 'Doge Miner';
    }
    if (game === 'monkeymart') {
        url = "https://gamecollections.me/game/3kh0-assets-main/MonkeyMart/";
        title = 'Monkey Mart';
    }
    return {
        url,
...
function toggleFullscreen(url, title) {
 ...
 iframe { width: 100vw; height: 100vh; border: none; margin: 0; padding: 0; display: block; box-shadow: 0 0 10px ${currentShadowColor}; }
 </style>
 </head>
 <body>
...
function createSnowflake() {
    if (snowflakes > 100) return;
    snowflakes++;
    const s = document.createElement('div');
    s.classList.add('snowflake');
    s.style.left = Math.random() * 100 + 'vw';
    s.style.width = s.style.height = (Math.random() * 2 + 2) + 'px';
    s.style.animationDuration = Math.random() * 5 + 5 + 's';
    s.style.backgroundColor = document.getElementById('snowColor')?.value || '#ffffff';
